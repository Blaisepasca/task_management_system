        ...
        <div class="card-body d-flex justify-content-between align-items-center pt-0 pl-3 pb-2 pr-0">
            <div class="d-inline-block">
                @foreach($project->users->where('is_active','=',true) as $counter => $user)
                    ...
                    @endif
                @endforeach
                    <a href="javascript:void(0)" data-id="{{ $project->id }}" data-toggle="modal" data-target="#assignProjectUserModal" class="edit-project-assignees"><img class="assignee__avatar p-1" src="{{ asset('assets/img/add.svg') }}"></a>
