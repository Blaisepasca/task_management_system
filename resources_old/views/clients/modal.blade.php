            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        {{ Form::email('email', '', ['id' => 'email', 'class' => 'form-control','tabindex' => '3']) }}
                    </div>
                </div>
                @can('manage_users')
                    <div class="custom-control custom-checkbox mb-2 " id="client_checkbox">
                        <input type="checkbox" class="custom-control-input" id="addClient">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        {{ Form::url('website', '', ['id' => 'website', 'class' => 'form-control', 'tabindex' => '6']) }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-4 col-sm-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <br>
                            <label class="image__file-upload btn btn-primary text-color-white" tabindex="7">
                ...
                <div class="text-right">
                    {{ Form::button(__('messages.common.save'), ['type' => 'submit', 'class' => 'btn btn-primary', 'id' => 'btnSave', 'data-loading-text' => "<span class='spinner-border spinner-border-sm'></span> Processing..." , 'tabindex' => '8']) }}
