    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb justify-content-end">
                <a href="{{ route('invoices.index') }}" class="btn btn-light form-btn">
...
@section('scripts')
    <script>
        ...
        let invoicesStoreUrl = "{{ route('invoices.store') }}";
        let invoicesUrl = "{{ route('invoices.index') }}";
        let invoiceEdit = true;
        let isCreate = false;
        let getProjectTasks = "{{ url('invoices') }}/";
        let getTaskDetails = "{{ url('invoices') }}/";
        let getClientProjects = "{{ url('invoices') }}/";
