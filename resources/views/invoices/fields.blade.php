    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="form-group">
                ...
                {{ Form::text('name', $report->name.' '.\Carbon\Carbon::parse($report->start_date)->format('Y-m-d').' '.__('messages.invoice.to').' '.\Carbon\Carbon::parse($report->end_date)->format('Y-m-d'), ['class' => 'form-control', 'required']) }}
            </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="form-group">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 d-none">
            <div class="form-group">
                ...
                {{ Form::select('tax_id', $taxes, null, ['class' => 'form-control tax-select-box', 'placeholder' => 'Select Tax']) }}
            </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 d-none">
            <div class="form-group">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 d-none">
            <div class="form-group">
                ...
                {{ Form::select('discount_type', $discountType, 0, ['class' => 'form-control', 'id' => 'discountTypeSelect', 'placeholder' => 'Select Discount type','required']) }}
            </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 d-none">
            <div class="form-group">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-right invoice-mobile-text-width d-none"><span>{{ __('messages.invoice.task_amount') }}<span
                                    class="required">*</span></span>
                    </th>
                    <th class="invoice-add-item d-none"><a href="#" id="itemAddBtn"><i class="fas fa-plus"></i></a></th>
                </tr>
                </thead>
