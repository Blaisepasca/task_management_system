...
<script>
    ...
    let notificationStoreUrl = "{{route('notifications.store')}}";
    let notificationIndexUrl = "{{route('notifications.index')}}";
    let trackerNotificationCommandUrl = '{{ route('tracker.notification.command') }}';
