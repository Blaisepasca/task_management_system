    ...
    <div class="row login-container">
            ...
            <div class="col-md-5">
                <div class="login-brand mb-0">
                    <img src="{{ !empty(getLogoUrl()) ? getLogoUrl() : asset('assets/img/logo-red-black.png') }}" alt="logo" width="100">
                </div>
                <div class="card p-0">
                        ...
                        <form method="post" action="{{ url('/login') }}">
                            ...
                            <div class="login-row row no-margin">
                               <i class="fas fa-envelope" ></i>
                                <input type="email" class="ml-3 form-control form-control-md {{ $errors->has('email')?'is-invalid':'' }}"
                                name="email" value="{{ (Cookie::get('email') !== null) ? Cookie::get('email') : old('email') }}"
                            ...
                            <div class="login-row row no-margin">
                                ...
                                <input type="password" class="ml-3 form-control form-control-md {{ $errors->has('password')?'is-invalid':'' }}" 
                                       value="{{ (Cookie::get('password') !== null) ? Cookie::get('password') : null }}" name="password"
