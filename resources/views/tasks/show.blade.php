                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label
                                                        ...
                                                        :</label>
                                                    <p>{{\Carbon\Carbon::parse($task->due_date)->format('dS F, Y')}}</p>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            @if(!empty($task->estimate_time))
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label
                                                                class="font-weight-bold">{{__('messages.task.estimate_time')}}
                                                            :</label>
                                                        <p class="flex-1">{{$task->estimate_time_type == \App\Models\Task::IN_HOURS ? $task->estimate_time.' '.__('messages.invoice.hours') : $task->estimate_time.' '.__('messages.task.days') }}</p>
                                                    </div>
                                                </div>
                                            @endif
                                            <div class="col-md-4">
