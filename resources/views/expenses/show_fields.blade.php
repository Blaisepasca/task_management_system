<div class="row">
    <div class="form-group col-md-4">
        ...
        <p>{{\Carbon\Carbon::parse($expense->date)->format('jS M, Y')}}</p>
    </div>
    <div class="form-group col-md-4">
        <label class="font-weight-bold">{{ __('messages.invoice.amount')}} :</label>
        <p><i class="{{ \App\Models\Project::getCurrencyClass($expense->project->currency) }}"></i> {{ number_format($expense->amount) }}</p>
    </div>
    <div class="form-group col-md-4">
