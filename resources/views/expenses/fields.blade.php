...
<div class="row">
    ...
    <div class="form-group col-lg-4 col-md-4 col-sm-12">
        ...
        {{ Form::text('amount', null, ['class' => 'form-control','id'=>'amount','required', 'autocomplete' => 'off','maxlength' => '11','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
    </div>
