...
<div class="file-attachment col-sm-6" id="file-attachment{{:id}}">
                   ...
                   {{:username}}</span> <br><small>{{:updated_at}}</small></div>
                                                                <div class="x-actions"><strong>
                                                                        <a href="{{:downloadTask}}/media/{{:id}} " class="download-attachment">Download <span class="x-icons"><i class="ti-download"></i></span></a></strong>
...
<script id="edit-due-date"  type="text/x-jsrender">
   <input type="text" class="cursor-pointer" name="task_date_due" id="task_date_due" autocomplete="off" value="{{:due_date}}">{{:due_date}}
</script>

<script id="status-text"  type="text/x-jsrender">
<span class="cursor-pointer" data-toggle="popover" id="status-data" data-placement="bottom" data-html="true">{{:status}}</span>
</script>

<script id="priority-text"  type="text/x-jsrender">
 <span class="cursor-pointer" data-toggle="popover" id="priority-data" data-placement="bottom" data-html="true">{{:priority}}</span>
</script>
...
<span data-id="{{:id}}" data-toggle="popover" id="edit-task-assignee-data" data-placement="bottom" data-html="true"><img class="assignee__avatar p-1 assignee" src="assets/img/add.svg"></span>
</script>
